...
console.log(`Tyrannosaurus weighs ${tyrannosaurus.weight}.`);

// What was the diet of a velociraptor?
console.log(`The velociraptor was a ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`The stegosaurus is ${stegosaurus.length} long.`);
...
const unisWithUni = graduates.filter(item => item.university.toLowerCase().includes("uni"));
...
*/
const populationTotal = zooAnimals.reduce((count, current) => count += current.population, 0);
